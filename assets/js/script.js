...
const CONFIG = {
    aspirantes: [
        { num: '404', name: 'ANA TAVARES', full: 'ASP Ana Tavares', photo: 'assets/images/aspirantes/ana-tavares.jpg',
            description: 'Ana Tavares, a tenacidade e foco são o seu maior ativo para ser uma oficial.'},
        { num: '405', name: 'ANA CAROLINA', full: 'ASP Ana Carolina', photo: 'assets/images/aspirantes/ana-carolina.jpg',
            description: 'Ana Carolina, jovem dedicada e disciplinada, inicia sua jornada na corporação com honra e compromisso.'},
        { num: '406', name: 'DOS ANJOS', full: 'ASP Dos Anjos', photo: 'assets/images/aspirantes/dos-anjos.jpg',
        ...
        { num: '407', name: 'MARIANA GUILHON', full: 'ASP Mariana Guilhon', photo: 'assets/images/aspirantes/mariana-guilhon.jpg',
            description: 'Filha de Bombeiro Militar, 24 anos, tem no estudo e dedicação a sua base para ser uma oficial.'},
        { num: '408', name: 'DANIEL BORGES', full: 'ASP Daniel Borges', photo: 'assets/images/aspirantes/daniel-borges.jpg',
        ...
        { num: '409', name: 'DIONE', full: 'ASP Dione', photo: 'assets/images/aspirantes/dione.jpg',
        ...
        { num: '410', name: 'MOREIRA', full: 'ASP Moreira', photo: 'assets/images/aspirantes/moreira.jpg',
        ...
        { num: '411', name: 'EDLAURO', full: 'ASP Edlauro', photo: 'assets/images/aspirantes/edlauro.jpg',
        ...
        { num: '412', name: 'BARRETO', full: 'ASP Barreto', photo: 'assets/images/aspirantes/barreto.jpg',
        ...
        { num: '414', name: 'DANIEL PEDRO', full: 'ASP Daniel Pedro', photo: 'assets/images/aspirantes/daniel-pedro.jpg',
        ...
        { num: '415', name: 'AMORIM', full: 'ASP Amorim', photo: 'assets/images/aspirantes/amorim.jpg',
        ...
        { num: '416', name: 'PAULA ALMEIDA', full: 'ASP Paula Almeida', photo: 'assets/images/aspirantes/paula-almeida.jpg',
            description: 'Paula Almeida, 24 anos, determinada e inteligente, dedicou-se e cumpriu o sonho de ser Bombeiro Militar.'
        },
        { num: '417', name: 'GUSTAVO', full: 'ASP Gustavo', photo: 'assets/images/aspirantes/gustavo.jpg',
        ...
        { num: '418', name: 'PRADO', full: 'ASP Prado', photo: 'assets/images/aspirantes/prado.jpg',
            description: ' Nascido em Manaus–AM e moldado pelos caminhos de São Luís–MA, Israel Lima Prado transita com naturalidade entre o pensar estratégico e o agir operacional, revelando uma versatilidade que o distingue. No CBMMA, não vê apenas uma profissão, mas um propósito genuíno, servir ao próximo é, para ele, a oportunidade de ser instrumento de Deus na proteção, no cuidado e na esperança. A cada dia, empenha-se em evoluir, honrar a farda e deixar, por onde passar, a marca do bem que escolheu fazer.'},
        { num: '419', name: 'PIETRO', full: 'ASP Pietro', photo: 'assets/images/aspirantes/pietro.jpg',
            description: 'Pietro é calmo, dedicado e sempre busca ajudar aos seus pares, um grande homem e um grande oficial.'},
        { num: '420', name: 'FELIPE SOUZA', full: 'ASP Felipe Souza', photo: 'assets/images/aspirantes/felipe-souza.jpg',
        ...
        { num: '421', name: 'DAMON', full: 'ASP Damon', photo: 'assets/images/aspirantes/damon.jpg',
            description: 'Damon é natural de Imperatriz-MA, antes um policial penal, realizou seu sonho de ser um oficial.'},
        { num: '422', name: 'GOMES', full: 'ASP Gomes', photo: 'assets/images/aspirantes/gomes.jpg',
            description: 'Cadete Gomes nascido em São Luís-Ma. Viu no CFO-BM uma oportunidade única concedida por Deus pra mudar de vida e ajudar o próximo.'},
        { num: '423', name: 'TEIXEIRA', full: 'ASP Teixeira', photo: 'assets/images/aspirantes/teixeira.jpg',
        ...
        { num: '424', name: 'EMERSON', full: 'ASP Emerson', photo: 'assets/images/aspirantes/emerson.jpg',
        ...
        { num: '425', name: 'HENRIQUE COSTA', full: 'ASP Henrique Costa', photo: 'assets/images/aspirantes/henrique-costa.jpg',
        ...
        { num: '426', name: 'TAINAM', full: 'ASP Tainam', photo: 'assets/images/aspirantes/tainam.jpg',
        ...
        { num: '427', name: 'LUÍS CÉSAR', full: 'ASP Luís César', photo: 'assets/images/aspirantes/luis-cesar.jpg',
        ...
        { num: '429', name: 'JULIANA COELHO', full: 'ASP Juliana Coelho', photo: 'assets/images/aspirantes/juliana-coelho.jpg',
        ...
        { num: '430', name: 'RAFAELA', full: 'ASP Rafaela', photo: 'assets/images/aspirantes/rafaela.jpg',
        ...
        { num: '431', name: 'LUCAS CUNHA', full: 'ASP Lucas Cunha', photo: 'assets/images/aspirantes/lucas-cunha.jpg',
            description: 'Lucas Cunha, Engenheiro Mecânico, é um jovem dedicado, comprometido, humilde e companheiro.'},
        { num: '432', name: 'JULYENE', full: 'ASP Julyene', photo: 'assets/images/aspirantes/julyene.jpg',
            description: 'Julyene, natural de São Luís-MA, serena, porém determinada e de coração generoso, nascida para ser uma grande oficial.'},
        { num: '433', name: 'BRENO', full: 'ASP Breno', photo: 'assets/images/aspirantes/breno.jpg',
        ...
        { num: '434', name: 'GABRIEL OLIVEIRA', full: 'ASP Gabriel Oliveira', photo: 'assets/images/aspirantes/gabriel-oliveira.jpg',
        ...
        { num: '435', name: 'FALCÃO', full: 'ASP Falcão', photo: 'assets/images/aspirantes/falcao.jpg',
        ...
        { num: '436', name: 'WELLISON', full: 'ASP Wellison', photo: 'assets/images/aspirantes/wellison.jpg',
            description: 'Mande a sua descrição'},
        { num: '437', name: 'RODOVALHO', full: 'ASP Rodovalho', photo: 'assets/images/aspirantes/rodovalho.jpg',
        ...
        { num: '438', name: 'RONALD', full: 'ASP Ronald', photo: 'assets/images/aspirantes/ronald.jpg',
    ...
    eventos: [
        ...
        {
            title: 'Baile de Gala',
            date: { month: 'Dez', day: '22', time: '21:00' },
            type: 'Social',
            icon: 'celebration',
